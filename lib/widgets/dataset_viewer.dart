  ...
  Widget build(BuildContext context) {
    return GetBuilder<WorkspaceController>(
      builder: (controller) {
        ...
        if (controller.selectedMrkIndex >= controller.mrkDatas.length) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: DropdownButton<int>(
              value: controller.selectedMrkIndex,
              isExpanded: true,
              ...
              onChanged: (int? newIndex) {
                if (newIndex != null) {
                  controller.selectedMrkIndex = newIndex;
                  controller.update();
                }
              },
            ),
          ...
          body: ListView.builder(
            itemCount: controller
                .mrkDatas[controller.selectedMrkIndex]
                .items
                .length,
